...
export const questionsAndAnswers = [
    ...
    {
        q: 'Is therapy inclusive?',
        a: (
            <>
                <p>
                    Some people face specific challenges to obtaining effective
                    therapy or their experiences in the past have felt
                    oppressive. Sometimes people feel they were not viewed
                    positively or clumsy assumptions were made about them.
                </p>
                <p>
                    In my practice I attempt to work in a way that appreciates,
                    affirms and values individual identities, backgrounds,
                    sameness and difference. My intention is to be an
                    anti-oppressive, inclusive therapist and to develop an
                    understanding of your unique experience.
                </p>
            </>
        ),
